...
public class Tests implements Runnable {
    ...
    public String testRegistrationSameUser() {
        ...
        try {
            ...
            if (numTimesSuccess == 1)
                ...
                response = ("Registration With Same User Test Failed! " + numTimesSuccess);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return response;
    ...
    String tryBulkStudentLogicalTests() {
        ...
        try {
            ...
            if (numTimesSuccess == numThreads * 2)
                ...
                response = ("Student Logical Tests Test Failed! " + numTimesSuccess +"/"+ numThreads*2);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return response;
    ...
    public String testMyCourses() {
        ...
        System.out.println(courseList + " --- " + myCourses);
    ...
    public String testStudentStat(){
        ...
        System.out.println(ack + "||" + studentName + "||" + coursesL);
        ...
        System.out.println(ack1 + " " + studentName1 + " " + coursesL1);
    ...
    public String testCourseStat(){
        ...
        System.out.println(ack + "||" + courseName.equals("Course: ("+p.getCourseNum()+") "+p.getCourseName()) + "||" + seats +"||" + studentsL);
        System.out.println(ack.equals("ACK 7") +"||"+ courseName.equals("Course: ("+p.getCourseNum()+") "+p.getCourseName()) + "||" + seats.equals("Seats Available: "+"0/"+numOfThreads) +"||" + studentsL.equals(students));
    ...
    public void run() {
        try {
            ...
            new Thread(() -> {
                TPCMain.main(new String[]{"7777","3"}); //You can change it to reactor also
            }).start();
